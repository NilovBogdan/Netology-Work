...
import bogdan.nilov.netologywork.databinding.CardJobBinding
import bogdan.nilov.netologywork.databinding.FragmentJobsBinding
import bogdan.nilov.netologywork.util.AppConst
import bogdan.nilov.netologywork.viewModel.AuthViewModel
import bogdan.nilov.netologywork.viewModel.JobViewModel
...
class JobsFragment : Fragment() {
    ...
    companion object {
        fun newInstance(): JobsFragment = JobsFragment()
    }
}