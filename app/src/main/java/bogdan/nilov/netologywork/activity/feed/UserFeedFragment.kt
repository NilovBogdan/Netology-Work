...
import bogdan.nilov.netologywork.adapter.UserAdapter
import bogdan.nilov.netologywork.databinding.FragmentUserFeedBinding
...
import bogdan.nilov.netologywork.viewModel.UserViewModel
...
class UserFeedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentUserFeedBinding.inflate(inflater, container, false)
