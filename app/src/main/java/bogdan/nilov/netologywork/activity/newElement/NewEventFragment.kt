package bogdan.nilov.netologywork.activity.newElement
...
import bogdan.nilov.netologywork.bottomSheetDialog.BottomSheetNewEvent
import bogdan.nilov.netologywork.databinding.FragmentNewEventBinding
import bogdan.nilov.netologywork.dto.AttachmentType
import bogdan.nilov.netologywork.extension.loadAttachment
import bogdan.nilov.netologywork.util.AndroidUtils.focusAndShowKeyboard
    ...
    override fun onCreateView(
        ...
        binding.addUser.setOnClickListener {
            findNavController().navigate(
                R.id.action_newEventFragment_to_userFeedFragment2,
        ...
        val imageProvider =
            ImageProvider.fromResource(requireContext(), R.drawable.ic_location_24)
